...
const translations: Record<Locale, Record<string, string>> = {
  nl: {
    ...
    'dashboard.title': 'CoreQueen',
    'dashboard.subtitle': '3× per week — controle & ademhaling',
    'dashboard.history': 'Geschiedenis',
    'dashboard.tour': 'Rondleiding',
    'dashboard.settings': 'Instellingen',
    'dashboard.reminderTitle': 'Tijd voor je workout!',
    'dashboard.dismiss': 'Sluiten',
    'dashboard.weekInRow': 'week op rij',
    'dashboard.weeksInRow': 'weken op rij',
    'dashboard.workoutsThisMonth': 'workouts deze maand',
    'dashboard.prevWeek': 'Vorige week',
    'dashboard.nextWeek': 'Volgende week',
    'dashboard.viewDaily': 'Dag',
    'dashboard.viewWeekly': 'Week',
    'dashboard.viewMonthly': 'Maand',
    'dashboard.prevDay': 'Vorige dag',
    'dashboard.nextDay': 'Volgende dag',
    'dashboard.prevMonth': 'Vorige maand',
    'dashboard.nextMonth': 'Volgende maand',
    'dashboard.today': 'Vandaag',
    'dashboard.workout': 'Workout',
    'dashboard.restDay': 'Rustdag',
  ...
  en: {
    ...
    'dashboard.title': 'CoreQueen',
    'dashboard.subtitle': '3× per week — control & breathing',
    'dashboard.history': 'History',
    'dashboard.tour': 'Tour',
    'dashboard.settings': 'Settings',
    'dashboard.reminderTitle': 'Time for your workout!',
    'dashboard.dismiss': 'Dismiss',
    'dashboard.weekInRow': 'week in a row',
    'dashboard.weeksInRow': 'weeks in a row',
    'dashboard.workoutsThisMonth': 'workouts this month',
    'dashboard.prevWeek': 'Previous week',
    'dashboard.nextWeek': 'Next week',
    'dashboard.viewDaily': 'Day',
    'dashboard.viewWeekly': 'Week',
    'dashboard.viewMonthly': 'Month',
